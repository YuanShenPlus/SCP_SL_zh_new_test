...
- 使用须知如下：
  - 本翻译包是基于游戏《SCP Secret Laboratory》的官方简体中文翻译包(zh_Hans)进行修改的,其主要内容为重新排版与字体美化.
...
- 截止目前,本翻译包仍处于制作状态中,只发布了五个"Demo"版本,~~正式版预计将在游戏更新14.0后发布在本项目中~~.(由于作者时间不是很充裕,正式版发布可能将会推迟)
...
- 将来可能会制作的翻译包系列：
  ...
  - 精神污染（~~简称瞎做~~）
  - 除此之外,偶尔将会发布内测版翻译包(Alpha),内测版翻译包不会同步在本项目中,只在[翻译包交流群](https://qm.qq.com/q/WidrCektW2)中发布.
...
- **简体中文-原版重置-测试版**
  - [**简体中文-原版重置-14.0-2025**](https://github.com/YuanShenPlus/SCP_SL_zh_new_test/releases/download/2/14.0.2.zip)
